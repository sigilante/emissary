  ...
  ++  page
    ...
    ;html
      ...
      ;body
        ...
        ;a(href "/apps/emissary/patron", class "button"):"patron"
        ;a(href "/apps/emissary/delegate", class "button"):"delegate"
        ;a(href "/apps/emissary/observer", class "button"):"observer"

        For more information, please visit the repo at
        ;a(href "https://github.com/sigilante/emissary"):"sigilante/emissary"

        Please direct questions or feedback to ~lagrev-nocfep.
      ==
    ==
  ::
  ++  sigil
